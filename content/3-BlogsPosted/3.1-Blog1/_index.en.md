...
This feature is especially useful when you have multiple applications running on the same IAM role but need different permission restrictions (e.g., one pod only reads a specific S3 bucket, another pod only calls certain APIs).
